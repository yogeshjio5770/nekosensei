...
service_content = """import 'package:cloud_firestore/cloud_firestore.dart';
...
with open(r'c:\duolingo\lib\services\battle_service.dart', 'w', encoding='utf-8') as f:
    f.write(service_content)
print("Updated battle_service.dart")
